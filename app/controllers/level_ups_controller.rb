class LevelUpsController < ApplicationController
  ...
  private
    ...
    def level_up_params
      params.expect(level_up: [ :from_level, :to_level, :skill_name, :skill_from, :stat_name, :second_stat_name, :subclass_name, :hit_die_roll_one, :hit_die_roll_two, :notes, { feature_choices: {} } ])
    end
